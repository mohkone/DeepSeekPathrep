...
Earlier pathology-report NLP studies provide important context for these report-understanding tasks. Prior systems extracted cancer-registry reportable variables from free-text pathology reports, parsed pathology attributes in limited-data settings with uncertainty estimation, used transfer learning and zero-shot string similarity to reduce annotation burden, and mapped oncologic pathology report content to tumor site, histology, and ICD-O-3 coding targets [16-19]. These studies show that pathology report abstraction is a mature clinical NLP problem, but also that many high-performing systems are task-specific and depend on curated annotations, coding schemas, or institution-specific report conventions.
...
9. Peng Y, Yan S, Lu Z. Transfer learning in biomedical natural language processing: an evaluation of BERT and ELMo on ten benchmarking datasets. Proceedings of the 18th BioNLP Workshop and Shared Task. 2019:58-65. doi:10.18653/v1/W19-5006.
10. Gu Y, Tinn R, Cheng H, Lucas M, Usuyama N, Liu X, et al. Domain-specific language model pretraining for biomedical natural language processing. ACM Transactions on Computing for Healthcare. 2022;3(1):1-23. doi:10.1145/3458754.
11. Luo R, Sun L, Xia Y, Qin T, Zhang S, Poon H, et al. BioGPT: generative pre-trained transformer for biomedical text generation and mining. Briefings in Bioinformatics. 2022;23(6):bbac409. doi:10.1093/bib/bbac409.
...
16. Alawad M, Gao S, Qiu JX, Yoon HJ, Christian JB, Penberthy L, et al. Automatic extraction of cancer registry reportable information from free-text pathology reports using multitask convolutional neural networks. Journal of the American Medical Informatics Association. 2020;27(1):89-98. doi:10.1093/jamia/ocz153.
17. Odisho AY, Park B, Altieri N, DeNero J, Cooperberg MR, Carroll PR, Yu B. Natural language processing systems for pathology parsing in limited data environments with uncertainty estimation. JAMIA Open. 2020;3(3):431-438. doi:10.1093/jamiaopen/ooaa029.
18. Park B, Altieri N, DeNero J, Odisho AY, Yu B. Improving natural language information extraction from cancer pathology reports using transfer learning and zero-shot string similarity. JAMIA Open. 2021;4(3):ooab085. doi:10.1093/jamiaopen/ooab085.
19. Mitchell JR, Szepietowski P, Howard R, Reisman P, Jones JD, Lewis P, Fridley BL, Rollison DE. A question-and-answer system to extract data from free-text oncological pathology reports (CancerBERT Network): development study. Journal of Medical Internet Research. 2022;24(3):e27210. doi:10.2196/27210.
